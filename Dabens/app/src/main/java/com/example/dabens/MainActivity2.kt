...
class MainActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val questionField =findViewById<EditText>(R.id.userquetion)
        val answerField = findViewById<EditText>(R.id.useranswer)
        val save_btn = findViewById<ImageView>(R.id.imageView4)
        val cancelBtn = findViewById<ImageView>(R.id.imageView3)
